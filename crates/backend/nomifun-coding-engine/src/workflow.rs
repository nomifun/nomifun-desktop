...
pub struct CodingCommandObservation {
...
pub struct CodingWorkStatus {
    ...
    #[serde(default)]
    pub recent_commands: Vec<CodingCommandObservation>,
    #[serde(default)]
    pub omitted_command_observations: u32,
}

impl CodingWorkStatus {
    ...
    pub(crate) fn observe(
        ...
        match binding.capability_id.as_ref() {
            ...
            "process.exec" => {
                ...
                self.recent_commands.push(CodingCommandObservation {
    ...
    pub(crate) fn completion_review_message(
        &self,
    ) -> Result<nomifun_chat_model_broker::ChatMessage, crate::CodingEngineError> {
        Ok(crate::context_lifecycle::text_message(
            ...
            format!(
                ...
                serde_json::to_string(self).map_err(|error| {
                    crate::CodingEngineError::InvalidContract(error.to_string())
                })?
            ),
        ))
    }
