...
pub(crate) fn validate_discarded(step: u16, calls: &[ToolCallId]) -> Result<(), CodingEngineError> {
...
fn invalid() -> CodingEngineError {
    CodingEngineError::InvalidModelEvent("invalid output-limit discard record".into())
}
