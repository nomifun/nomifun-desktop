...
/// `KnowledgeService`; the Runtime depends on this trait.
#[async_trait]
...
/// `KnowledgeService::write_file`; the Runtime depends on this trait.
///
...
/// Backend seam for knowledge write-back. Implemented by the backend over its
/// `KnowledgeService::write_document`; the Runtime depends on this trait.
