//! Runtime-only model-window policy. Original results reach evidence tracking
...
pub(crate) fn project(kind: ToolContextKind, result: &AgentToolResult) -> AgentToolResult {
