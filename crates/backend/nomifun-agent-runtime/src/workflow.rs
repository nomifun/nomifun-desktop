...
pub(crate) const LONG_HORIZON_EXECUTION_INSTRUCTIONS: &str = concat!(
    ...
    "After the first failed workspace command, call update_plan ALONE before retrying effects: explain the failure, keep one step in_progress, and cite a short exact accepted-input quote. ",
