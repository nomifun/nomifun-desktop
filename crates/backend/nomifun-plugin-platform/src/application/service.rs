...
use crate::application::{PluginShareBundleFilesystem, PluginShareExport};
...
impl PluginApplicationService {
    ...
    pub async fn set_enabled(
        ...
        if request.enabled && !self.host.runtime_available().await? {
            return Err(PluginServiceError::Coded {
                code: crate::application::ERR_RUNTIME,
    ...
    async fn finish_build_error(
        ...
        let canceled = error.code() == crate::application::ERR_OPERATION_CANCELED;
...
fn require_project_owner(
    ...
    if project.owner_user_id == owner_user_id {
        ...
        Err(PluginServiceError::Coded {
            code: crate::application::ERR_FORBIDDEN,
