...
pub const RUNTIME_BUILD_BINDING_KEY: &str = "runtime_build_binding";

#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct RuntimeBuildDescriptor {
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub struct RuntimeBuildBinding {
    pub family_id: String,
    pub build_id: String,
    pub build_digest: String,
    pub host_contract_version: u32,
...
fn invalid(message: &str) -> AppError {
    AppError::BadRequest(format!("Runtime build contract: {message}"))
}

impl RuntimeBuildDescriptor {
