...
impl From<nomifun_plugin_platform::PluginArtifactStoreError> for PluginServiceError {
    fn from(value: nomifun_plugin_platform::PluginArtifactStoreError) -> Self {
        Self::Coded {
            code: ERR_ARTIFACT,
...
impl From<nomifun_plugin_platform::OwnerMutationError> for PluginServiceError {
    fn from(value: nomifun_plugin_platform::OwnerMutationError) -> Self {
