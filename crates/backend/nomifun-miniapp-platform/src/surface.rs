...
use crate::{MiniAppM1ApplicationError, MiniAppSurfaceAsset};

const SURFACE_CAPABILITY_BYTES: usize = 32;

pub fn issue_surface_capability() -> Result<String, MiniAppM1ApplicationError> {
...
mod tests {
    ...
    fn surface_capabilities_are_opaque_and_only_digest_is_persistable() {
        ...
        assert!(matches!(
            ...
            Err(MiniAppM1ApplicationError::NotFound)
        ));
    }
