...
import zh from '@renderer/services/i18n/locales/zh-CN/creativeStudio.json';
import en from '@renderer/services/i18n/locales/en-US/creativeStudio.json';
import ImageSizePicker from './ImageSizePicker';
import { imageGenerationSizePolicyForModel } from './image';
...
afterEach(() => cleanup());
const options = imageGenerationSizePolicyForModel(null).options;
...
describe('ImageSizePicker interactions', () => {
  ...
  test('supports disabled controls and policy changes without stale higher resolutions', () => {
    ...
    const restricted = imageGenerationSizePolicyForModel({ model: 'step-image-edit-2', protocol: 'stepfun.images' });
