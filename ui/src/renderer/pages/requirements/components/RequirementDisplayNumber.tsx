  ...
  const badge = (
    <span
      ...
      className={[
        ...
        fullId
          ? 'cursor-copy transition-colors hover:border-[var(--color-primary-light-4)] hover:bg-[var(--color-primary-light-1)] hover:text-primary-6 focus-visible:outline-2 focus-visible:outline-[rgba(var(--primary-6),1)]'
          : '',
        className,
      ]
        .filter(Boolean)
