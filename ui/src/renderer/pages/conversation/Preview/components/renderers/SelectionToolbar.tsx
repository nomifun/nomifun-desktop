...
const SelectionToolbar: React.FC<SelectionToolbarProps> = ({ selectedText, position, onClear }) => {
  ...
  return (
    <div ref={refs.setFloating} style={{ ...floatingStyles, zIndex: 99999 }}>
      <div
        className='flex items-center px-12px py-8px bg-[var(--color-bg-2)] rd-8px shadow-lg border-1px border-solid border-[var(--color-border-2)] cursor-pointer hover:opacity-80 transition-opacity'
