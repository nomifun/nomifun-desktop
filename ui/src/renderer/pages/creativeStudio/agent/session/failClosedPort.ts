...
export const CREATIVE_STUDIO_AGENT_SESSION_BACKEND_GAP = Object.freeze({
  ...
  requiredContract: Object.freeze([
    'An authenticated owner-scoped resolve-or-create operation keyed by projectId and sessionId',
    'A database uniqueness constraint on ownerId, projectId, and sessionId',
  ...
  currentLimitation:
    'The current public conversation API exposes list/create/update separately and conversation.extra is client-writable, while Creative Studio project CAS persistence is a separate service transaction.',
} as const);
