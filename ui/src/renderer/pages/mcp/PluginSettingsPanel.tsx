...
const PluginSettingsPanel: React.FC<PluginSettingsPanelProps> = ({ section = 'both' }) => {
  ...
  return (
    <div className='space-y-16px pb-24px'>
      {showInstalled && <div className='bg-fill-2 rounded-24px p-20px'>
        ...
        {loading ? (
          ...
          <div className='grid gap-12px' style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(min(260px, 100%), 1fr))' }}>
      ...
      {showMarket && <MarketSettingsPanel
