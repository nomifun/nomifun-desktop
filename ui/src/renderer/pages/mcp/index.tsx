...
const McpPage: React.FC = () => {
  ...
  const activeTab = isMcpTab(searchParams.get('tab')) ? searchParams.get('tab')! : 'servers';
  const autoEditServerName = searchParams.get('editMcp') ?? undefined;
    ...
    >
      ...
      >
        ...
        <Tabs.TabPane key='market' title={t('settings.mcpPage.mcpMarketTab', { defaultValue: 'MCP Market' })}>
          <McpMarketSettings setMcpServers={setMcpServers} saveMcpServers={saveMcpServers} />
        </Tabs.TabPane>
