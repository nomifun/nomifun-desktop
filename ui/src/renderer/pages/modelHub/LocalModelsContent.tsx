  ...
  return (
    <div className='flex flex-col bg-2 rd-16px px-24px py-16px'>
      ...
      <div className='flex-shrink-0 border-b border-[var(--color-border-2)] pb-12px mb-14px flex flex-col gap-10px'>
        <div className='flex items-center justify-between gap-12px flex-wrap'>
          <div className='flex items-center gap-8px min-w-0'>
            ...
            <div className='min-w-0'>
              ...
              <div className='mt-1px text-13px leading-18px text-t-secondary'>{t('settings.modelHub.local.providerId')}</div>
            </div>
          </div>
        ...
        >
          <Info theme='outline' size='16' className='shrink-0 mt-1px text-[rgb(var(--primary-6))]' />
          <div className='min-w-0'>
            <div className='text-13px font-600 leading-18px text-t-primary'>{t('settings.modelHub.local.privacyTitle')}</div>
            <div className='mt-2px text-12px leading-18px text-t-secondary'>{t('settings.modelHub.local.privacyNotice')}</div>
            <div className='mt-4px text-12px leading-18px text-t-secondary'>{t('settings.modelHub.local.scopeNotice')}</div>
          </div>
        </div>
        ...
        <div className='rd-10px border border-solid border-[var(--color-border-2)] bg-[var(--fill-0)] px-12px py-10px'>
          <div className='flex items-center justify-between gap-12px flex-wrap'>
            <div>
              <div className='text-12px font-500 text-t-secondary'>{t('settings.modelHub.local.runtime.title')}</div>
              <div className='mt-2px text-13px font-500 text-t-primary'>
                {runtime
              ...
              return (
                <section
                  ...
                  className={classNames(
                    'rd-12px border border-solid px-14px py-13px transition-colors',
                    isActive
