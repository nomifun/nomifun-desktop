...
const ProviderAutoConfigurationNotice: React.FC<{
  ...
  return (
    <div
      className='flex min-h-34px items-center gap-8px border-0 border-l-2px border-l-solid border-primary-5 bg-fill-1 px-10px py-7px text-11px text-t-secondary'
