...
/**
 * 休眠时段 — genuinely per-companion (stored on the profile's appearance), unlike
 * the learning settings above. An empty range means the companion may speak up
 * around the clock.
 */
  ...
  return (
    <NomiSettingSection
      ...
      description={t('nomi.evolution.quietSectionDesc', {
        defaultValue: '给这个伙伴安排一段安静时间，只影响它主动找你的方式。',
      })}
    >
      <NomiSettingList>
        <NomiSettingRow
          ...
          description={t('nomi.evolution.quietRangeDesc', {
            defaultValue:
              '时段内桌面伙伴不再弹气泡打扰你，未读提醒仍会累计到它的角标上；学习和技能生成照常进行。留空表示全天都可以打扰。',
          })}
          controls={
