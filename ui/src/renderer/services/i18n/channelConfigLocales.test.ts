...
const CHANNEL_SETTINGS_KEYS = [
  ...
  'channels.nostrTitle',
  'channels.tokenRequired',
  'channels.tokenLocked',
  'channels.testConnection',
  'channels.connectionSuccess',
  'channels.connectionFailed',
  'channels.pluginEnabled',
  'channels.pluginDisabled',
  'channels.botToken',
  'channels.botTokenDesc',
  'channels.nextSteps',
  'channels.step1',
  'channels.step2',
  'channels.step3',
  'channels.step4',
  'channels.pendingPairings',
  'channels.noPendingPairings',
  'channels.pairingCode',
  'channels.expiresIn',
  'channels.approve',
  'channels.reject',
  'channels.pairingApproved',
  'channels.pairingRejected',
  'channels.authorizedUsers',
  'channels.noAuthorizedUsers',
  'channels.platform',
  'channels.authorizedAt',
