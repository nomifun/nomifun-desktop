 ...
 * is the explicit `default` connection; these DTOs cover the extra
...
export type { ProviderConnectionInput } from '@/common/protocolBindings/ProviderConnectionInput';
export type { SaveProviderConnectionRequest } from '@/common/protocolBindings/SaveProviderConnectionRequest';
