...
- 注释/文案随上下文语言；交流用中文。提交以 `NomiFun Contributor <nomifun@users.noreply.github.com>` 署名，**不**加 `Co-Authored-By` trailer：`git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m ...`。
...
git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "fix(chat): 输入法上屏 Enter 防误发送，提取提交手势纯函数"
```
...
git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "feat(chat): 新增发送键偏好(chat.sendKey)并在会话框/引导页生效"
```
...
git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "feat(settings): 系统设置新增「发送快捷键」偏好项"
```
...
git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "feat(db): 新增 delete_messages_from 按 keyset 游标截断删除消息"
```
...
git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "feat(engine): 新增 turn 起始锚点与 rewind_last_turn 回退最后一个用户 turn"
```
...
git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "feat(agent): manager/AgentInstance 暴露 rewind_last_turn(仅 Nomi)"
```
...
git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "feat(conversation): 新增 edit_and_resubmit 服务与 /edit-resubmit 路由(仅 Nomi、仅最近一条)"
```
...
git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "feat(chat): ipcBridge.editResubmit 与 sendbox.edit 事件"
```
...
git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "feat(chat): 新增 useRemoveMessagesFrom 本地按时间截断消息"
```
...
git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "feat(chat): SendBox 支持编辑模式(回填+提示条+提交分流)"
```
...
git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "feat(nomi): NomiSendBox 接入 editResubmit 提交编辑重跑"
```
...
git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "feat(chat): 用户消息悬浮工具行新增「编辑」按钮(仅 Nomi+最近一条)"
```
...
```bash
git add -A && git -c user.name=nomifun -c user.email=nomifun@users.noreply.github.com commit --author="NomiFun Contributor <nomifun@users.noreply.github.com>" -m "chore(chat): 编辑重发与发送键偏好联调收尾"
```
