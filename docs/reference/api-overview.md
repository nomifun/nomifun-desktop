...
| Plugin platform and Product management | `/api/plugins/*`: workspace, drafts, authoring, projects, mounts, operations, and installation-scoped Plugin state | instance owner; mutations additionally require local product trust | [`router/plugin_product`](../../crates/backend/nomifun-app/src/router/plugin_product/) |
| Plugin Product runtimes | `/api/plugins/runtimes/*`: projects, Workshop, source, build/test/publish/rollback, enablement, publish mode, Service lifecycle, share/backup/import, trash/restore/delete, and Surface open/close | instance owner; mutations additionally require local product trust | [`router/plugin_runtime.rs`](../../crates/backend/nomifun-app/src/router/plugin_runtime.rs) |
